...
#define CLASS_IO__Z2IOEV 6
#define CLASS_IO__Z8writevalE1Tp 7
#define CLASS_IO__Z9fwritevalE1HC1Tp15X6Yappend5Ystart 8
#define CLASS_IO__Z8freadvalE1HC 9
...
/* Definition of Class: 'IO' */
	...
	VDM_CLASS_FIELD_DEFINITION(IO,numFields);
